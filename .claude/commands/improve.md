...
description: |
  ...
  直近のタスク実行を分析してLEARNED.md更新提案を生成する。
---
...
ユーザーが承認した場合のみ、LEARNED.mdの「学習済みルール」セクションに追記する。

```bash
# 追記場所の確認
grep -n "学習済みルール" LEARNED.md
```

## 注意事項

- 提案のみ行い、承認なしにLEARNED.mdを変更しない
